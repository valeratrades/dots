...
can() {
	...
	sudo ln ${HOME}/.file_snippets/rust_gitignore ./.gitignore -f
	git add -A
...
pyn() {
	...
	sudo ln ${HOME}/.file_snippets/py_gitignore ./.gitignore
...
gon() {
	...
	sudo ln ${HOME}/.file_snippets/go_gitignore ./.gitignore
